              ...
              <div className="grid gap-12 md:grid-cols-3">
                <AnimateIn delayMs={80}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Combine Shopify, web/app events, email, SMS, and push so all tests read from the same behavioral and revenue data.
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn delayMs={120}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Segment customers into groups like Champions, Regulars, Promising, Needs Attention, and At Risk using recency, frequency, spend, and behavior.
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn delayMs={160}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Use the same segments and conditions to target website, recommendation, and journey experiments instead of rebuilding logic in separate tools.
                    </p>
                  </div>
                </AnimateIn>
              </div>
              ...
              <div className="grid gap-12 md:grid-cols-3">
                <AnimateIn delayMs={80}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Run A/B and multi-variant tests on complete journeys (landing, collection, PDP, cart) and compare add-to-cart, checkout starts, conversion, and AOV by variant.
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn delayMs={120}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Experiment with cross-sell, lookalike, and margin-focused strategies in PDP and cart slots and measure clicks, attach rate, and AOV lift per strategy and segment.
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn delayMs={160}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Test static vs dynamic campaigns, different trigger logic, and timing rules in journeys, all operated off real behavior and lifecycle changes.
                    </p>
                  </div>
                </AnimateIn>
              </div>
              ...
              <div className="grid gap-12 md:grid-cols-3">
                <AnimateIn delayMs={80}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Break results down by lifecycle segment, device, and channel to see what works for high-value customers versus new visitors.
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn delayMs={120}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Use built-in experiment metrics to compare variants on conversion, revenue per visitor, and impact on key goals before promoting a winner.
                    </p>
                  </div>
                </AnimateIn>
                ...
                <AnimateIn delayMs={160}>
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-base leading-7 text-black/65">
                      Turn winning variants into new defaults for site, recommendations, and journeys so every test improves the next one instead of competing with it.
                    </p>
                  </div>
                </AnimateIn>
              </div>
