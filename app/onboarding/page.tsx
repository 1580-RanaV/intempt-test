          ...
          >
              ...
              <StepCard>
                ...
                <div className="mt-6 grid gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="flex items-center rounded-sm border border-black/15 bg-[white] px-3 py-2 text-sm font-semibold text-black/70 focus-within:ring-2 focus-within:ring-[#0382ff]/40">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between rounded-sm border border-dashed border-black/15 bg-[white] px-4 py-3">
                        <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-[110px_1fr] gap-2 rounded-sm border border-black/15 bg-[white] px-3 py-2 text-sm font-semibold text-black/70 focus-within:ring-2 focus-within:ring-[#0382ff]/40">
                        <input
                          value="+1"
                          readOnly
            ...
            <Step>
              <StepCard>
                ...
                <div className="mt-4 rounded-sm border border-black/15 bg-[white] p-4">
                  ...
                  {TOOL_OPTIONS.map((tool) => {
                    ...
                    return (
                      <button
                        ...
                        className={[
                          "flex items-center justify-between rounded-sm border px-4 py-3 text-left transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
                          isSelected
                            ? "border-[#0382ff] bg-[white]"
                            : "border-black/15 bg-[white] hover:-translate-y-0.5 hover:shadow-sm",
                        ].join(" ")}
                      >
              ...
              <StepCard>
                ...
                <div className="mt-6 grid gap-3 lg:grid-cols-2">
                  {selectedToolList.length === 0 ? (
                    <div className="rounded-sm border border-dashed border-black/15 bg-[white] px-4 py-6 text-center text-sm font-semibold text-black/60">
                    ...
                    selectedToolList.map((tool) => (
                      <div
                        key={tool}
                        className="flex items-start justify-between gap-4 rounded-sm border border-black/15 bg-[white] px-4 py-3"
                      >
                        <div className="space-y-1">
                ...
                <div className="mt-6 flex items-center gap-3 rounded-sm border border-black/15 bg-[white] px-4 py-3">
                  <LockIcon />
  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        readOnly={readOnly}
        className={[
          "w-full rounded-sm border border-black/15 bg-[white] px-3 py-3 text-sm font-semibold text-black/80 outline-none transition focus:ring-2 focus:ring-[#0382ff]/40",
...
function GhostButton({ label, icon }: { label: string; icon: string }) {
  return (
    <button className="flex items-center justify-center gap-3 rounded-sm border border-black/15 bg-[white] px-4 py-3 text-sm font-semibold text-black/80 transition hover:-translate-y-0.5 hover:shadow-sm">
...
function RoleCard({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={[
        "flex h-full flex-col items-start gap-3 rounded-sm border px-4 py-4 text-left transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
        active
          ? "border-[#0382ff] bg-[white] shadow-sm"
          : "border-black/15 bg-[white] hover:-translate-y-0.5 hover:shadow-sm",
      ].join(" ")}
    >
      <div className="flex items-center gap-2">
